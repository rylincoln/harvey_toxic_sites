...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/libs/mapbox.standalone.css">
  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <span class="navbar-brand title">loading...</span>
        </div>
    ...
    <!-- <script src="assets/libs/mapbox.standalone.js"></script> -->
